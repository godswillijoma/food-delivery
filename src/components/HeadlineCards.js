    ...
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      <div className="rounded-xl relative hover:scale-105 duration-500">
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          <p className="font-bold text-2xl px-2 pt-4">Delicious Meals</p>
          <p className="px-2">24/7</p>
          <button className="border border-white bg-white text-black px-5 py-1 mx-2 absolute bottom-4 rounded-full">
            Order Now
          </button>
        </div>
        <img

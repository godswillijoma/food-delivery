...
const NavBar = () => {
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      <div className="bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[500px] lg:w-[600px]">
      ...
      {/* Cart Button */}
      <button className="bg-black text-white hidden md:flex items-center px-5 py-2 rounded-full">
